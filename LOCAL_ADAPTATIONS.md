# Internship adaptations

This fork preserves the research code originally developed by
...
- support for RFLDA datasets with fewer than 50 features;
- an optional fixed-threshold evaluation mode and single-class safeguards;
- a plain Random Forest baseline with the same model interface.
